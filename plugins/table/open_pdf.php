...
<html dir="ltr" mozdisallowselectionprint>
  <head>
    ...
    <title></title> 
    <link rel="stylesheet" href="/misc/pdfjs/web/viewer.css"> 
    <?php misc('jquery');?>
	<script src="/misc/pdfjs/build/pdf.js"></script>
	<script>
        window.addEventListener('load', function() {
            PDFViewerApplication.open('https://wx.qihetaiji.com/uploads/wx_qihetaiji_com/1/2022-11-06/6367932a5985c.pdf')
        });
 </script>
    <script src="/misc/pdfjs/web/viewer.js"></script> 
